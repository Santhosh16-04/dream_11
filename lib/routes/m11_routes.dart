import 'package:clever_11/presentation/screens/c11_payment/c11_main_payment.dart';
import 'package:clever_11/presentation/screens/c11_payment/c11_payment_options.dart';
  ...
  static Map<String, WidgetBuilder> routes = {
    ...
    m11_login: (context) {
      ...
      if (args == null || args is! Map<String, dynamic>) {
        return const M11_LoginTeleportation();
      }
      return M11_LoginTeleportation(
        initialMobileNumber: args['mobileNumber'],
